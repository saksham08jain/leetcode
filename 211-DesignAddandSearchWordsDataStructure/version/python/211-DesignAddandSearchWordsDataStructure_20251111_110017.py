# Last updated: 11/11/2025, 11:00:17
class TrieNode:
    def __init__(self):
        self.children = {}
        self.word = False
                ...
                for prev_str,prev_node in cur_pos: 
                    ...
                    for prev_str,prev_node in cur_pos:
                        for nextt in prev_node.children:
                            new_pos.append((prev_str+nextt,prev_node.children[nextt]))
            cur_pos=new_pos
        #if any of cur_pos is a Word return True 
        for _,node in cur_pos:
            if node.word:
                return True 
        return False
